...
const NOTIF_TYPES = [
  { key: 'low-stock', label: 'Hàng sắp hết', icon: PkgIcon, color: 'text-amber-400', bgColor: 'bg-amber-500/10' },
  { key: 'report', label: 'Báo cáo chờ duyệt', icon: FileText, color: 'text-red-400', bgColor: 'bg-red-500/10' },
  { key: 'store-verify', label: 'Cửa hàng mới', icon: Store, color: 'text-blue-400', bgColor: 'bg-blue-500/10' },
]
  ...
  return (
    <Card className="w-full border-gray-800 bg-gray-950 rounded-2xl overflow-hidden">
      <CardContent className="p-4 sm:p-5">
        ...
        <p className="text-xs text-gray-500 mb-4">Chọn loại thông báo bạn muốn nhận:</p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
          {NOTIF_TYPES.map(({ key, label, icon: Icon, color, bgColor }) => {
            ...
            return (
              ...
              >
                <div className={`flex h-8 w-8 items-center justify-center rounded-lg ${enabled ? bgColor : 'bg-gray-800'}`}>
                  {enabled ? (
                ...
                <div className="text-left">
                  <p className={enabled ? 'text-gray-200' : 'text-gray-500'}>{label}</p>
 ...
 */
function DesktopSidebar({ user, role, isAdmin, theme, setTheme, signingOut, onSignOut }) {
            ...
            <div className="p-5 space-y-5">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="min-w-0 flex-1">
                  <p className="truncate text-[15px] font-semibold text-gray-100">{user?.email}</p>
 ...
 */
function MobileProfileHeader({ user, role, isAdmin, theme, setTheme, signingOut, onSignOut }) {
  const roleLabel = isAdmin ? 'Admin' : role === 'telesale' ? 'Telesale' : 'Khách'
            ...
            return (
              ...
              >
                <Icon className={`h-5 w-5 shrink-0 transition-transform duration-150 group-hover:scale-110 ${
                  item.accent ? 'text-white' : 'text-gray-500 group-hover:text-gray-300'
                }`} />
...
export default function AccountScreen() {
  ...
  return (
    <>
      ...
      <div className="min-h-full bg-black text-gray-100">
        <div
        ...
        >
          ...
          <header className="mb-5 sm:mb-8">
            ...
            <p className="mt-1 text-sm text-gray-500">Quản lý thông tin cá nhân và truy cập nhanh các tính năng</p>
          </header>
                ...
                <Card className="w-full border-gray-800 bg-gray-950 rounded-2xl">
                  <CardContent className="p-5 text-center">
                    ...
                    <p className="text-gray-400">
                      Bạn đang đăng nhập với quyền khách. Một số tính năng bị giới hạn.
                    </p>
                  </CardContent>
                </Card>
              )}
