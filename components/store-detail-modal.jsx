        ...
        <div className="px-4 pt-4 pb-2 space-y-3">
          ...
          <div className="flex items-start justify-between gap-2">
            ...
            {typeof store.distance === 'number' && (
              <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-medium bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-300 flex-shrink-0 whitespace-nowrap">
        ...
        {user && (
          <div className="px-4 pb-4 pt-0 flex gap-2">
            ...
            <Button
              ...
              size="sm"
              disabled={deleting}
              className={`flex-1 h-10 text-sm rounded-xl transition-colors ${deleteConfirm ? 'border-red-500 text-red-500 bg-red-50 dark:bg-red-950/30 hover:bg-red-100' : 'text-red-500 hover:border-red-400'}`}
