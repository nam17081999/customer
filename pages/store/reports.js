        ...
        <div className="mx-auto max-w-screen-md space-y-4 px-3 py-4 sm:px-4 sm:py-6">
              ...
              <div className="flex items-start justify-between gap-3">
                <div>
                  ...
                  <p className="text-sm text-gray-400">
                    Danh sách báo cáo chờ xử lý. Bấm vào từng mục để xem màn chi
                    tiết riêng.
                  </p>
                </div>
                <Button
          ...
          <div className="space-y-3">
            {reports.map((report) => {
              ...
              const reasonLabels = (report.reason_codes || []).map(
                (code) => reasonLabelMap[code] || code,
              );
                  ...
                  <CardContent className="space-y-3 p-4">
                    <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                      ...
                      <Button asChild className="w-full sm:w-auto">
                        <Link href={`/store/reports/${report.id}`}>
                          Xem chi tiết
                        </Link>
                      </Button>
                    </div>
