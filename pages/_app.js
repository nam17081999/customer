...
const PAGE_TITLES = {
  ...
  '/store/create': { title: 'Thêm hàng hóa', subtitle: 'Nhập thông tin hàng hóa mới' },
  ...
  '/store/edit/[id]': { title: 'Sửa hàng hóa', subtitle: 'Chỉnh sửa thông tin hàng hóa' },
  '/store/verify': { title: 'Duyệt hàng hóa', subtitle: 'Xác nhận hàng hóa mới' },
  '/store/reports': { title: 'Duyệt báo cáo', subtitle: 'Báo cáo từ người dùng' },
  '/store/deduplicate': { title: 'Gộp trùng lặp', subtitle: 'Xử lý hàng hóa trùng' },
