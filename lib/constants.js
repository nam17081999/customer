...
export const STORE_TYPE_OPTIONS = [
  ...
  { value: 'quan_an', label: 'Quán ăn - Quán cơm' },
  { value: 'quan_nuoc', label: 'Quán nước' },
  { value: 'sieu_thi', label: 'Siêu thị - Mart - Cửa hàng tiện lợi' },
  { value: 'kho', label: 'Kho' },
];
...
export const REPORT_REASON_OPTIONS = [
  ...
  { code: 'wrong_image', label: 'Ảnh không đúng' },
];

// ImageKit.io configuration (client-safe only)
...
// NOTE: Private key is accessed via process.env.IMAGEKIT_PRIVATE_KEY in server-side code only (lib/imagekit.js)
